...
public class CustomerController {
    ...
    @PreAuthorize("hasRole('USER')")
    public List<Customer> getCustomers(@PathVariable("userid") String id) {
    ...
    @PreAuthorize("hasRole('USER')")
    public Optional<Customer> getCustomersbyID( @PathVariable("customerid") int customerid) {
        return customerService.getCustomerByUserandCustomerID(customerid);
